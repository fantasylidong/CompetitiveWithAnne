...
- Upgraded `infected_control.smx` to 2026-08-13.3. This release reworks spawn dispersion so a wave no longer lands in one small cluster, and adds controlled randomness to the class lineup. The wave timing contract (kill phase, independent 16-second base countdown, Anti-Bait) is unchanged.
