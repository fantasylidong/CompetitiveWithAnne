...
public void OnPluginStart()
{
    ...
    g_hCvar_Plugins                = CreateConVar("nb_uf_onoff", "1", "插件是否接管update frequency,1接管,0不接管", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_COMMON]       = CreateConVar("nb_uf_Common", "0.02", "Common的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_SMOKER]       = CreateConVar("nb_uf_Smoker", "0.05", "Smoker的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_BOOMER]       = CreateConVar("nb_uf_Boomer", "0.05", "Boomer的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_HUNTER]       = CreateConVar("nb_uf_Hunter", "0.02", "Hunter的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_SPITTER]      = CreateConVar("nb_uf_Spitter", "0.05", "Spitter的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_JOCKEY]       = CreateConVar("nb_uf_Jockey", "0.05", "Jockey的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_CHARGER]      = CreateConVar("nb_uf_Charger", "0.05", "Charger的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_WITCH]        = CreateConVar("nb_uf_Witch", "0.02", "Witch的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_TANK]         = CreateConVar("nb_uf_Tank", "0.02", "Tank的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_SURVIVOR_BOT] = CreateConVar("nb_uf_sb", "0.1", "Survivor Bot的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
