...
public void OnPluginStart()
{
    ...
    g_hCvar_UpdateFrequency[NPC_SMOKER]       = CreateConVar("nb_uf_Smoker", "0.1", "Smoker的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    ...
    g_hCvar_UpdateFrequency[NPC_HUNTER]       = CreateConVar("nb_uf_Hunter", "0.05", "Hunter的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
    g_hCvar_UpdateFrequency[NPC_SPITTER]      = CreateConVar("nb_uf_Spitter", "0.1", "Spitter的update frequency更新频率.", FCVAR_NONE, true, 0.0, true, 1.0);
